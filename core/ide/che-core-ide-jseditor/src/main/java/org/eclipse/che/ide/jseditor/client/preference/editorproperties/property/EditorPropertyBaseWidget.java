...
/**
 * The base widget to create property's widget which contains label for name of property and panel for value box.
 *
 * @author Roman Nikitenko
 */
class EditorPropertyBaseWidget extends Composite implements EditorPropertyWidget{
